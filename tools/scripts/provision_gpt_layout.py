#!/usr/bin/env python3
"""GPT layout helpers for CAPYOS disk provisioning."""
...
from provision_gpt_disk import SECTOR, parse_size_to_bytes
...
def partition_gpt(img: Path, esp_size: str, boot_size: str) -> None:
    ...
    def write_entry(
        index: int, type_guid: str, first_lba: int, last_lba: int, name: str
    ) -> None:
