...
- `install.sh`, `install-linux.sh` e `install-windows.ps1` sao wrappers.
- `tools/scripts/install_deps.sh` e `tools/scripts/install_deps_windows.ps1`
  contem a logica de instalacao.
