...
- [ ] Se a mudanca tocou em algum item de `docs/plans/active/capyos-master-plan.md`
      (plano vivo unico; o antigo `capyos-robustness-master-plan.md` foi
      consolidado em `historical/`), o status do item foi atualizado
      seguindo a regra:
