...
- `docs/plans/active/system-master-plan.md` - fases 0-12, visao completa
- `docs/plans/historical/system-delivery-roadmap.md` - entregas A1-D3, estado atual
- `docs/plans/active/system-roadmap.md` - roadmap por dominio
- `docs/plans/historical/platform-hardening-plan.md` - marcos A-E
- `docs/plans/historical/refactor-plan.md` - migracao x64
- `docs/plans/experimental/hyperv-network-reset-plan.md` - rede Hyper-V
- `docs/plans/experimental/network-hyperv-refactor-and-update-plan.md` - refatoracao rede
