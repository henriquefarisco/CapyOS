...
| 7 | Browser usável com web estática moderna | Em andamento (alpha.298) | Etapa 6 | HTTPS real, decode JPEG/PNG/WebP, streaming render, HTTP cache, forms, sem JavaScript |
