...
- **Plano sequencial novo (pós-reordenação ROI):** Etapas 1-7 oficialmente fechadas; 7/16 etapas concluídas; Etapa 8 em andamento com um critério aberto. A regressão de boot foi removida na `alpha.320` e a entrada sem COM1 foi corrigida na `alpha.321`; o aceite A/B oficial VMware permanece pendente.
...
Hoje as Etapas 1-7 estão fechadas, a Etapa 8 está ativa e somente as Etapas 9-16
permanecem bloqueadas. Repositórios apartados podem evoluir em paralelo (CapyUI já entregou v2.22.0 com
