...
**Data:** 2026-07-15 | **Versao:** `0.8.0-alpha.315+20260715` | **Plataforma oficial:** VMware + UEFI + E1000 | **Publico alvo:** usuario desktop comum
...
## Repositórios apartados (estado em alpha.315)
...
[`compatibility-audit-2026-07-15.md`](../reference/integration/compatibility-audit-2026-07-15.md).
...
| [`CapyAI`](../../../CapyAI) | `0.2.0` | orquestrador governado, modelo on-device e core C freestanding reproduzivel (`capy-ai-core` artifact v0) | Etapas 7-8 |
