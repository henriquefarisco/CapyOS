...
- **Sequencia atual:** Etapa 9 implementada e validada localmente na `0.10.0-alpha.1`; integração/publicação da branch ainda precede o fechamento oficial e o desbloqueio da Etapa 10.
...
| 9 | Package manager + SDK + ABI estável | **Candidata validada** | implementação, QEMU e VMware concluídos; aguarda integração/publicação |
