...
**Data:** 2026-07-20 | **Versao:** `0.8.0-alpha.316+20260720` | **Plataforma oficial:** VMware + UEFI + E1000 | **Publico alvo:** usuario desktop comum
...
- **Etapa 8 em andamento:** o preflight autenticado do updater agora inicializa
  ...
  fail-closed (`-60`) até existir boot-control A/B e rollback após reboot; nenhum
  critério de aceite da Etapa 8 foi marcado como concluído por esta fatia.
...
- **Etapa 8 — hardening do instalador:** o loader deixa de escolher o maior
  ...
  falha se nao houver exatamente um alvo elegivel. A fatia elimina o wipe antes
  do preflight, mas o criterio da Etapa 8 segue aberto ate o gate VMware
  multi-disco provar fresh install, reboot, login, persistencia e disco guard
  intacto.
...
- **Plano sequencial novo (pós-reordenação ROI):** Etapas 1-7 oficialmente fechadas; 7/16 etapas concluídas; Etapa 8 em andamento.
...
## Repositórios apartados (estado em alpha.316)
...
[`compatibility-audit-2026-07-20.md`](../reference/integration/compatibility-audit-2026-07-20.md).
