...
- **Sequência atual:** Etapa 9 publicada como stable Latest imutável na `0.10.0+20260904`; Etapa 10 está desbloqueada como próxima.
...
| 10 | Áudio + multimídia básica | **Desbloqueada (próxima)** | integra `CapyCodecs` áudio por contrato |
