...
**Data:** 2026-07-12 | **Versao:** `0.8.0-alpha.313+20260712` | **Plataforma oficial:** VMware + UEFI + E1000 | **Publico alvo:** usuario desktop comum
...
## Repositórios apartados (estado em alpha.313)
...
|---|---|---|---|
| [`CapyUI`](../../../CapyUI) | `2.24.0` | widget model (`capy-ui-widget` v2.22, display-list schema v7), desktop session e chat CapyAI assincrono | Etapas 4, 6 e 7 |
...
| [`CapyAI`](../../../CapyAI) | `0.1.0` | modelo on-device e core C freestanding reproduzivel (`capy-ai-core` v0) | Etapa 7 |
