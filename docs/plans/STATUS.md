...
**Data:** 2026-07-30 | **Versao:** `0.8.0-alpha.320+20260730` | **Plataforma oficial:** VMware + UEFI + E1000 | **Publico alvo:** usuario desktop comum
...
- **Plano sequencial novo (pós-reordenação ROI):** Etapas 1-7 oficialmente fechadas; 7/16 etapas concluídas; Etapa 8 em andamento com um critério aberto. A regressão de boot foi removida na `alpha.320`; o aceite A/B oficial VMware permanece pendente.
...
## Repositórios apartados (estado em alpha.320)
