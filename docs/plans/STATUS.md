...
**Data:** 2026-06-17 ? **Vers?o:** `0.8.0-alpha.280+20260617` ? **Plataforma oficial:** VMware + UEFI + E1000 ? **P?blico alvo:** usu?rio desktop comum
...
## Repositórios apartados (estado em alpha.280, Etapa 6 ativa)
...
|---|---|---|---|
| [`CapyUI`](../../../CapyUI) | `2.22.5` | widget model (`capy-ui-widget` v2.22, display-list schema v7) **e** desktop session (`capy-ui-desktop-session` v1, publicado em `alpha.241`) | Etapas 4 e 6 |
