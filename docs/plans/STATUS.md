...
**Data:** 2026-06-11 ? **Vers?o:** `0.8.0-alpha.265+20260611` ? **Plataforma oficial:** VMware + UEFI + E1000 ? **P?blico alvo:** usu?rio desktop comum
...
- **Etapa atual:** Etapa 6 — Apps básicos do desktop maduros + `CapyBrowse Text` (desbloqueada pelo fecho da Etapa 5 em alpha.264; Slice 6.4 desbloqueado por handoff CapyBrowser v0.6.0 em alpha.265).
...
## Repositórios apartados (estado em alpha.265, Etapa 6 ativa)
...
| [`CapyBrowser`](../../../CapyBrowser) | `0.6.0` | browser-core text/HTML/CSS est?tico (`capy-browser-core`; pacote textual `org.capyos.browser.text` publicado para 6.4; core gráfico ainda Etapa 7) | Etapas 6-7 |
