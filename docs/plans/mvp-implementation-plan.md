# Plano de implementacao do MVP do CapyOS
...
- login, CLI e persistencia de arquivos e usuarios validados em reboot
...
### 1.4 Seguranca, filesystem e multiusuario

| Tema | Estado atual | Proximo alvo |
|---|---|---|
| Criptografia | AES-XTS + PBKDF2 no volume `DATA` | integridade autenticada e rotacao de chaves |
| CAPYFS | volume persistente operacional | journal, recovery e fsck |
...
- remover scripts e alvos nao usados
...
- nenhum documento ativo recomendando fluxo legado
...
- regressao de boot e persistencia apos a migracao de 32 bits para 64 bits
- risco de o runtime cair para acesso RAW mesmo quando a particao `DATA` ja
  estava valida
