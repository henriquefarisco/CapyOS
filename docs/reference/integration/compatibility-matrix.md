...
**Atualizacao alpha.314 (2026-07-13):** CapyOS
`0.8.0-alpha.314+20260713`, CapyBrowser `0.6.7`, CapyUI `2.24.0` e
CapyAI `0.1.0` formam o conjunto pinado desta release. O navegador mantem o
escopo estatico (sem JavaScript), mas permanece aberto ao lidar com paginas
pesadas; o desktop integra o chat CapyAI assincrono e o indice agregado passa a
ser publicado pelo CapyOS.
...
|---|---|---|---|---|
| `CapyOS` | `0.8.0-alpha.314+20260713` | `capyos-base` v3 + `capyos-package-apply` v1 | — (autoritativo) | — |
