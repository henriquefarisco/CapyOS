...
| `CapyUI` | `2.22.3` | `capy-ui-widget` v2.22 (display-list schema v7) + `capy-ui-desktop-session` v1 (+ apps-basic-roundtrip smoke surface, Slice 6.6, alpha.278) | `2.22.3` (cross-repo build / capypkg modulo / display-list adapter Etapa 4) | `2.22.3` (CI release gates com sibling remoto em main) |
