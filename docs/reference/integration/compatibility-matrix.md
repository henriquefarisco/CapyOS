...
| `CapyUI` | `2.22.6` | `capy-ui-widget` v2.22 (display-list schema v7) + `capy-ui-desktop-session` v1 (+ apps-basic-roundtrip smoke surface, Slice 6.6, alpha.278-281: 5 apps basicos; task_manager smoke corrigido p/ run queue vazia em alpha.281) | `2.22.6` (cross-repo build / capypkg modulo / display-list adapter Etapa 4) | `2.22.6` (CI release gates com sibling remoto em main) |
