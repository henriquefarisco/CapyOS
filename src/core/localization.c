...
const char *localization_normalize_language(const char *input) {
  ...
  if (strings_equal_ci(input, "pt") || strings_equal_ci(input, "pt-br") ||
      strings_equal_ci(input, "pt_br")) {
    return "pt-BR";
  }
  if (strings_equal_ci(input, "en") || strings_equal_ci(input, "en-us") ||
      strings_equal_ci(input, "en_us")) {
    return "en";
  }
  if (strings_equal_ci(input, "es") || strings_equal_ci(input, "es-es") ||
      strings_equal_ci(input, "es_es")) {
    return "es";
  }
  return NULL;
}
