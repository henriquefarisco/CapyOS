...
static const char *g_cli_reference_text =
    ...
    "\n"
    "Pacotes (capypkg)\n"
    "  pkg-list [--installed|--available] - lista pacotes\n"
    "  pkg-info <nome>      - metadados do pacote\n"
    "  pkg-fetch            - sincroniza indice dos repositorios\n"
    "  pkg-install <nome>   - instala (verifica SHA-256 e assinatura)\n"
    "  pkg-remove <nome>    - remove pacote instalado\n"
    "  pkg-update [<nome>]  - atualiza um ou todos os pacotes\n"
    "  pkg-source-list      - lista repositorios configurados\n"
    "  pkg-source-add <nome> <https-url> [--unsigned]\n"
    "  pkg-source-remove <nome>\n"
    "\n"
    "Ajuda\n"
