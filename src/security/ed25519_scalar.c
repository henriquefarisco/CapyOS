...
/* Multiplication is intentional: shifting a negative signed carry is
 * undefined in C, while the ref10 carry chain permits negative values. */
#define SC_LIMB_RADIX INT64_C(2097152)

static int64_t sc_scale_carry(int64_t carry) {
  return carry * SC_LIMB_RADIX;
}
...
void sc_reduce64(uint8_t out[32], const uint8_t in[64]) {
  ...
  carry6 = (s6 + (1LL << 20)) >> 21;
  s7 += carry6;
  s6 -= sc_scale_carry(carry6);
  carry8 = (s8 + (1LL << 20)) >> 21;
  s9 += carry8;
  s8 -= sc_scale_carry(carry8);
  carry10 = (s10 + (1LL << 20)) >> 21;
  s11 += carry10;
  s10 -= sc_scale_carry(carry10);
  carry12 = (s12 + (1LL << 20)) >> 21;
  s13 += carry12;
  s12 -= sc_scale_carry(carry12);
  carry14 = (s14 + (1LL << 20)) >> 21;
  s15 += carry14;
  s14 -= sc_scale_carry(carry14);
  carry16 = (s16 + (1LL << 20)) >> 21;
  s17 += carry16;
  s16 -= sc_scale_carry(carry16);
  carry7 = (s7 + (1LL << 20)) >> 21;
  s8 += carry7;
  s7 -= sc_scale_carry(carry7);
  carry9 = (s9 + (1LL << 20)) >> 21;
  s10 += carry9;
  s9 -= sc_scale_carry(carry9);
  carry11 = (s11 + (1LL << 20)) >> 21;
  s12 += carry11;
  s11 -= sc_scale_carry(carry11);
  carry13 = (s13 + (1LL << 20)) >> 21;
  s14 += carry13;
  s13 -= sc_scale_carry(carry13);
  carry15 = (s15 + (1LL << 20)) >> 21;
  s16 += carry15;
  s15 -= sc_scale_carry(carry15);
  s5 += s17 * 666643;
  s6 += s17 * 470296;
  s7 += s17 * 654183;
  s8 -= s17 * 997805;
  ...
  carry0 = (s0 + (1LL << 20)) >> 21;
  s1 += carry0;
  s0 -= sc_scale_carry(carry0);
  carry2 = (s2 + (1LL << 20)) >> 21;
  s3 += carry2;
  s2 -= sc_scale_carry(carry2);
  carry4 = (s4 + (1LL << 20)) >> 21;
  s5 += carry4;
  s4 -= sc_scale_carry(carry4);
  carry6 = (s6 + (1LL << 20)) >> 21;
  s7 += carry6;
  s6 -= sc_scale_carry(carry6);
  carry8 = (s8 + (1LL << 20)) >> 21;
  ...
  carry1 = (s1 + (1LL << 20)) >> 21;
  s2 += carry1;
  s1 -= sc_scale_carry(carry1);
  carry3 = (s3 + (1LL << 20)) >> 21;
  s4 += carry3;
  s3 -= sc_scale_carry(carry3);
  carry5 = (s5 + (1LL << 20)) >> 21;
  s6 += carry5;
  s5 -= sc_scale_carry(carry5);
  carry7 = (s7 + (1LL << 20)) >> 21;
  s8 += carry7;
  s7 -= sc_scale_carry(carry7);
  carry9 = (s9 + (1LL << 20)) >> 21;
...
void sc_muladd(uint8_t out[32], const uint8_t a[32],
  ...
  s19 += carry18;
  s18 -= sc_scale_carry(carry18);
  carry20 = (s20 + (1LL << 20)) >> 21;
  s21 += carry20;
  s20 -= sc_scale_carry(carry20);
  carry22 = (s22 + (1LL << 20)) >> 21;
  s23 += carry22;
  s22 -= sc_scale_carry(carry22);
  carry1 = (s1 + (1LL << 20)) >> 21;
  s2 += carry1;
  s1 -= sc_scale_carry(carry1);
  carry3 = (s3 + (1LL << 20)) >> 21;
  ...
  s18 += carry17;
  s17 -= sc_scale_carry(carry17);
  carry19 = (s19 + (1LL << 20)) >> 21;
  s20 += carry19;
  s19 -= sc_scale_carry(carry19);
  carry21 = (s21 + (1LL << 20)) >> 21;
  s22 += carry21;
  s21 -= sc_scale_carry(carry21);
