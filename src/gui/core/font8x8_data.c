/* font8x8_data.c: 8x8 bitmap font data and extended glyph/accent support.
 * Extracted from kernel_main.c for modularity. */
...
int fbcon_lookup_extended_glyph(uint8_t uc, uint8_t *base,
  ...
  switch (uc) {
  case 0x80: *base = 'C'; *accent = FBCON_ACCENT_CEDILLA;    return 1;
  case 0x81: *base = 'u'; *accent = FBCON_ACCENT_DIAERESIS;  return 1;
  case 0x82: *base = 'e'; *accent = FBCON_ACCENT_ACUTE;      return 1;
  case 0x83: *base = 'a'; *accent = FBCON_ACCENT_CIRCUMFLEX; return 1;
  case 0x85: *base = 'a'; *accent = FBCON_ACCENT_GRAVE;      return 1;
  case 0x87: *base = 'c'; *accent = FBCON_ACCENT_CEDILLA;    return 1;
  case 0x88: *base = 'e'; *accent = FBCON_ACCENT_CIRCUMFLEX; return 1;
  case 0x8C: *base = 'i'; *accent = FBCON_ACCENT_CIRCUMFLEX; return 1;
  case 0x90: *base = 'E'; *accent = FBCON_ACCENT_ACUTE;      return 1;
  case 0x93: *base = 'o'; *accent = FBCON_ACCENT_CIRCUMFLEX; return 1;
  case 0x96: *base = 'u'; *accent = FBCON_ACCENT_CIRCUMFLEX; return 1;
  case 0x9A: *base = 'U'; *accent = FBCON_ACCENT_DIAERESIS;  return 1;
  case 0xA0: *base = 'a'; *accent = FBCON_ACCENT_ACUTE;      return 1;
  case 0xA1: *base = 'i'; *accent = FBCON_ACCENT_ACUTE;      return 1;
  case 0xA2: *base = 'o'; *accent = FBCON_ACCENT_ACUTE;      return 1;
  case 0xA3: *base = 'u'; *accent = FBCON_ACCENT_ACUTE;      return 1;
  case 0xB5: *base = 'A'; *accent = FBCON_ACCENT_ACUTE;      return 1;
  case 0xB7: *base = 'A'; *accent = FBCON_ACCENT_GRAVE;      return 1;
  case 0xC6: *base = 'a'; *accent = FBCON_ACCENT_TILDE;      return 1;
  case 0xC7: *base = 'A'; *accent = FBCON_ACCENT_TILDE;      return 1;
  case 0xD6: *base = 'I'; *accent = FBCON_ACCENT_ACUTE;      return 1;
  case 0xE0: *base = 'O'; *accent = FBCON_ACCENT_ACUTE;      return 1;
  case 0xE4: *base = 'O'; *accent = FBCON_ACCENT_TILDE;      return 1;
  case 0xE5: *base = 'o'; *accent = FBCON_ACCENT_TILDE;      return 1;
  case 0xE9: *base = 'U'; *accent = FBCON_ACCENT_ACUTE;      return 1;
  default:   *base = '?'; *accent = FBCON_ACCENT_NONE;       return 0;
  }
}
...
const uint8_t *font_glyph(uint8_t uc) {
  ...
  if (fbcon_lookup_extended_glyph(uc, &base, &accent)) {
    fbcon_copy_glyph(extended_glyph, font8x8_basic[base]);
