/* MIGRATED: this source moved to CapyUI/src/desktop/internal/taskbar_internal.h as part of the
 * alpha.241 desktop-session hygiene slice. The CapyOS Makefile
 * compiles the canonical copy from $(CAPYUI_DIR)/src/desktop/internal/taskbar_internal.h via the
