/* MIGRATED: this source moved to CapyUI/src/desktop/desktop_icons.c as part of the
 * alpha.241 desktop-session hygiene slice. The CapyOS Makefile
 * compiles the canonical copy from $(CAPYUI_DIR)/src/desktop/desktop_icons.c via the
