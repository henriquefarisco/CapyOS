/* MIGRATED: this source moved to CapyUI/src/desktop/taskbar_menu.c as part of the
 * alpha.241 desktop-session hygiene slice. The CapyOS Makefile
 * compiles the canonical copy from $(CAPYUI_DIR)/src/desktop/taskbar_menu.c via the
