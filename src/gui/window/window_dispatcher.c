/* MIGRATED: this source moved to CapyUI/src/window/window_dispatcher.c as part of the
 * alpha.241 desktop-session hygiene slice. The CapyOS Makefile
 * compiles the canonical copy from $(CAPYUI_DIR)/src/window/window_dispatcher.c via the
