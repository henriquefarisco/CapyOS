...
static struct gui_theme_palette g_theme = {
  0x001A2B25, 0x00243D34, 0x003D6652, 0x0000C364, 0x00314F44, 0x00F0FFF0,
  0x0092B7A6, 0x0000C364, 0x003D6652, 0x00FFFFFF, 0x00142420, 0x00F0FFF0,
  0x003D6652, 0x001A2420, 0x00F0F0F0, 1
};
...
void compositor_apply_theme(const char *theme, uint32_t screen_w, uint32_t screen_h) {
  ...
  if (theme && comp_streq(theme, "sunset")) {
    g_theme.wallpaper = 0x00281810;
    g_theme.window_bg = 0x00382820;
    g_theme.window_border = 0x00604830;
    g_theme.title_active = 0x00E08020;
    g_theme.title_inactive = 0x00604830;
    g_theme.text = 0x00FFF0E0;
    g_theme.text_muted = 0x00C0A888;
    g_theme.accent = 0x00E08020;
    g_theme.accent_alt = 0x00604830;
    g_theme.accent_text = 0x00FFFFFF;
    g_theme.taskbar_bg = 0x00201810;
    g_theme.taskbar_fg = 0x00FFF0E0;
    g_theme.taskbar_highlight = 0x00604830;
    g_theme.terminal_bg = 0x00302018;
    g_theme.terminal_fg = 0x00FFF0E0;
  ...
  if (theme && comp_streq(theme, "midnight")) {
    g_theme.wallpaper = 0x00181028;
    g_theme.window_bg = 0x00282040;
    g_theme.window_border = 0x00483868;
    g_theme.title_active = 0x009060D0;
    g_theme.title_inactive = 0x00483868;
    g_theme.text = 0x00F0E8FF;
    g_theme.text_muted = 0x00A898C0;
    g_theme.accent = 0x009060D0;
    g_theme.accent_alt = 0x00483868;
    g_theme.accent_text = 0x00FFFFFF;
    g_theme.taskbar_bg = 0x00181028;
    g_theme.taskbar_fg = 0x00F0E8FF;
    g_theme.taskbar_highlight = 0x00483868;
    g_theme.terminal_bg = 0x00201838;
    g_theme.terminal_fg = 0x00F0E8FF;
    g_theme.ui_scale = scale;
    comp_wallpaper = g_theme.wallpaper;
    request_scene_redraw();
    return;
  ...
  if (theme && comp_streq(theme, "ocean")) {
    g_theme.wallpaper = 0x00081830;
    g_theme.window_bg = 0x00183050;
    g_theme.window_border = 0x00305878;
    g_theme.title_active = 0x0035B7FF;
    g_theme.title_inactive = 0x00305878;
    g_theme.text = 0x00E8F4FF;
    g_theme.text_muted = 0x0089AFCF;
    g_theme.accent = 0x005FD5FF;
    g_theme.accent_alt = 0x00305878;
    g_theme.accent_text = 0x00FFFFFF;
    g_theme.taskbar_bg = 0x00102040;
    g_theme.taskbar_fg = 0x00E8F4FF;
    g_theme.taskbar_highlight = 0x00305878;
    g_theme.terminal_bg = 0x00142848;
    g_theme.terminal_fg = 0x00E8F4FF;
    g_theme.ui_scale = scale;
    comp_wallpaper = g_theme.wallpaper;
    request_scene_redraw();
    return;
  ...
  if (theme && comp_streq(theme, "forest")) {
    g_theme.wallpaper = 0x00142818;
    g_theme.window_bg = 0x00204030;
    g_theme.window_border = 0x00386848;
    g_theme.title_active = 0x002FAE5B;
    g_theme.title_inactive = 0x00386848;
    g_theme.text = 0x00F0FFF0;
    g_theme.text_muted = 0x0092B7A6;
    g_theme.accent = 0x0048D778;
    g_theme.accent_alt = 0x00386848;
    g_theme.accent_text = 0x00FFFFFF;
    g_theme.taskbar_bg = 0x001A3020;
    g_theme.taskbar_fg = 0x00F0FFF0;
    g_theme.taskbar_highlight = 0x00386848;
    g_theme.terminal_bg = 0x001C3824;
    g_theme.terminal_fg = 0x00F0FFF0;
    g_theme.ui_scale = scale;
    comp_wallpaper = g_theme.wallpaper;
    request_scene_redraw();
    return;
  ...
  g_theme.wallpaper = 0x001A2B25;
  g_theme.window_bg = 0x00243D34;
  g_theme.window_border = 0x003D6652;
  g_theme.title_active = 0x0000C364;
  g_theme.title_inactive = 0x00314F44;
  g_theme.text = 0x00F0FFF0;
  g_theme.text_muted = 0x0092B7A6;
  g_theme.accent = 0x0000C364;
  g_theme.accent_alt = 0x003D6652;
  g_theme.accent_text = 0x00FFFFFF;
  g_theme.taskbar_bg = 0x00142420;
  g_theme.taskbar_fg = 0x00F0FFF0;
  g_theme.taskbar_highlight = 0x003D6652;
  g_theme.terminal_bg = 0x001A2420;
...
void compositor_init(uint32_t *framebuffer, uint32_t width, uint32_t height,
  ...
  for (int i = 0; i < COMPOSITOR_MAX_WINDOWS; i++) {
    if (windows[i].surface.pixels) {
      free_surface(windows[i].surface.pixels);
      windows[i].surface.pixels = NULL;
    }
    windows[i].id = 0;
    windows[i].visible = 0;
    windows[i].focused = 0;
    windows[i].on_paint = NULL;
    windows[i].on_close = NULL;
    windows[i].on_resize = NULL;
    windows[i].on_key = NULL;
    windows[i].on_mouse = NULL;
    windows[i].on_scroll = NULL;
    windows[i].user_data = NULL;
  }
