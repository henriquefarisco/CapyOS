/* MIGRATED: this source moved to CapyUI/src/apps/internal/settings_internal.h as part of the
 * alpha.241 desktop-session hygiene slice. The CapyOS Makefile
 * compiles the canonical copy from $(CAPYUI_DIR)/src/apps/internal/settings_internal.h via the
