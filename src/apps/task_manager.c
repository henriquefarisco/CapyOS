/* MIGRATED: this source moved to CapyUI/src/apps/task_manager.c as part of the
 * alpha.241 desktop-session hygiene slice. The CapyOS Makefile
 * compiles the canonical copy from $(CAPYUI_DIR)/src/apps/task_manager.c via the
