...
int main(void) {
    ...
    failures += test_browser_ipc_image_run();
    failures += test_capybrowser_image_cache_run();
    ...
    failures += test_browser_runtime_image_run();
    ...
    failures += test_capyhtml_raster_image_run();
