...
int main(int argc, char **argv) {
    ...
    failures += run_fsck_geometry_tests();
    ...
    failures += run_capypkg_tests();
    failures += run_capypkg_local_bundle_tests();
    ...
    failures += run_hyperv_vmbus_stage_tests();
    failures += run_vmbus_ring_tests();
    failures += run_vmbus_mouse_protocol_tests();
    ...
    failures += run_storvsc_scsi_tests();
    failures += run_storvsc_io_tests();
    ...
    failures += run_ahci_dispatch_tests();
    failures += run_nvme_commands_tests();
    failures += run_nvme_controller_reset_tests();
    failures += run_ata_status_tests();
    ...
    failures += test_compositor_smoke_gate_run();
    failures += test_widget_damage_run();
    failures += test_overlay_damage_run();
    failures += test_font_cache_run();
    failures += test_capyui_display_adapter_run();
    failures += test_terminal_display_list_run();
    failures += test_terminal_ansi_display_list_run();
    failures += test_terminal_ansi_sequence_display_list_run();
    failures += test_terminal_ansi_sequence_more_display_list_run();
    failures += test_terminal_ansi_sequence_extra_display_list_run();
    ...
    failures += run_tls_trust_anchors_tests();
    failures += run_tls_trust_userland_sync_tests();
    failures += run_tls_client_engine_tests();
    failures += run_tls_handshake_drive_tests();
    failures += run_tls_cert_validation_tests();
    failures += test_boot_slot_block_provider_run();
    failures += test_boot_slot_run();
    failures += test_boot_slot_store_run();
    failures += test_storage_boot_provider_policy_run();
    ...
    failures += test_browser_render_pixel_run();
