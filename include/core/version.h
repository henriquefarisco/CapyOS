...
#define CAPYOS_VERSION_PRERELEASE   "alpha.312"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.312"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.312+20260712"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.312"
