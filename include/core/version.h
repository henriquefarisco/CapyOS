...
#define CAPYOS_VERSION_PRERELEASE   "alpha.6"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.6"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.6+20260503"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.6"
