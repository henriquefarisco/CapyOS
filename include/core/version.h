...
#define CAPYOS_VERSION_PRERELEASE   "alpha.308"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.308"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.308+20260702"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.308"
