...
#define CAPYOS_VERSION_PRERELEASE   "alpha.3"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.3"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.3+20260429"
#define CAPYOS_FEATURE_HYPERV_RUNTIME "hvrt-20260328a"
#define CAPYOS_FEATURE_NETWORK_DIAG   "netdiag-20260328a"

#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.3"
