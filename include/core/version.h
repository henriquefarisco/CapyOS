...
#define CAPYOS_VERSION_PRERELEASE   "alpha.309"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.309"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.309+20260702"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.309"
