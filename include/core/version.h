...
#define CAPYOS_VERSION_PRERELEASE   "alpha.242"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.242"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.242+20260520"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.242"
