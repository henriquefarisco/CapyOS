...
#define CAPYOS_VERSION_PRERELEASE   "alpha.319"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.319"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.319+20260728"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.319"
