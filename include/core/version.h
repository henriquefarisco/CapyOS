...
#define CAPYOS_VERSION_PRERELEASE   "alpha.299"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.299"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.299+20260617"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.299"
