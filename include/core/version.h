...
#define CAPYOS_VERSION_PRERELEASE   "alpha.307"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.307"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.307+20260701"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.307"
