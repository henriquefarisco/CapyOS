...
#define CAPYOS_VERSION_PRERELEASE   "alpha.262"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.262"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.262+20260602"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.262"
