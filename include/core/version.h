...
#define CAPYOS_VERSION_PRERELEASE   "alpha.291"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.291"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.291+20260617"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.291"
