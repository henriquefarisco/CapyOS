...
#define CAPYOS_VERSION_PRERELEASE   "alpha.320"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.320"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.320+20260730"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.320"
