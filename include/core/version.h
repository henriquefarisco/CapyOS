...
#define CAPYOS_VERSION_PRERELEASE   "alpha.255"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.255"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.255+20260521"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.255"
