...
#define CAPYOS_VERSION_PRERELEASE   "alpha.314"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.314"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.314+20260713"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.314"
