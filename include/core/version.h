...
#define CAPYOS_VERSION_PRERELEASE   "alpha.265"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.265"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.265+20260611"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.265"
