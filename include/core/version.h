...
#define CAPYOS_VERSION_PRERELEASE   "alpha.316"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.316"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.316+20260720"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.316"
