...
#define CAPYOS_VERSION_PRERELEASE   "alpha.290"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.290"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.290+20260617"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.290"
