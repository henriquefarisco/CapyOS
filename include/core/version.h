...
#define CAPYOS_VERSION_PRERELEASE   "alpha.257"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.257"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.257+20260523"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.257"
