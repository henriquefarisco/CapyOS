...
#define CAPYOS_VERSION_PRERELEASE   "alpha.263"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.263"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.263+20260606"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.263"
