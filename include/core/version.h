...
#define CAPYOS_VERSION_PRERELEASE   "alpha.241"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.241"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.241+20260519"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.241"
