...
#define CAPYOS_VERSION_PRERELEASE   "alpha.238"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.238"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.238+20260515"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.238"
