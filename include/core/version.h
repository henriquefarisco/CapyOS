...
#define CAPYOS_VERSION_PRERELEASE   "alpha.261"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.261"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.261+20260529"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.261"
