...
#define CAPYOS_VERSION_PRERELEASE   "alpha.315"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.315"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.315+20260715"
...
#define CAPYOS_FEATURE_BROWSER_RUNTIME "browser-20260712a"

#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.315"
