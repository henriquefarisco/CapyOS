...
#define CAPYOS_VERSION_PRERELEASE   "alpha.256"
#define CAPYOS_VERSION_EXTENDED     "0.8.0-alpha.256"
#define CAPYOS_VERSION_FULL         "0.8.0-alpha.256+20260522"
...
#define CAPYOS_VERSION_ALPHA        "0.8.0-alpha.256"
